...
do -- //UI Stuff
    ...
    do --// Theme
        ...
        ThemeManager.Folder = 'Reapers Hub'
        ...
        function ThemeManager:ThemeUpdate()
            ...
            local options = { "Font", "Main", "Accent", "Background", "Outline" }
            for i, field in next, options do
                if Options and Options[field.."Color"] then
                    self.Library[field.."Color"] = Options[field.."Color"].Value
                    MobileUI.Colors[field] = Options[field.."Color"].Value
                    MobileUI:UpdateColors(
                        MobileUI.Colors.Accent,
                        MobileUI.Colors.Background,
                        MobileUI.Colors.Main,
                        MobileUI.Colors.Font,
                        MobileUI.Colors.Outline
                    )
                end
            end
        ...
        function ThemeManager:CreateThemeManager(groupbox)
            local ThemeColors = {"Background", "Main", "Accent", "Outline", "Font"}
            -- local ThemeColors = {"BackgroundColor", "MainColor", "AccentColor", "OutlineColor", "FontColor"}
            ...
            -- for _,v in ThemeColors do
            --     Options[v.."Color"]:OnChanged(function()
            --         -- print('[2] it changed')
            --         MobileUI.Colors[v] = Options[v.."Color"].Value
            --     end)
            -- end
